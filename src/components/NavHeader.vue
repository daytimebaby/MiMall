                            ...
                            <ul>
                                <li class="product" v-for="(item, index) in phoneList" :key="index">
                                    <a v-bind:href="'/product/' + item.id" target="_blank">
                                        ...
                                        <div class="pro-price">{{ item.price | currency(item.price) }}</div>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="children">
                            <ul>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="./../../public/imgs/nav-img/nav-2.png">
                                        </div>
                                        <div class="pro-name">小米cc9</div>
                                        <div class="pro-price">2999</div>
                                    </a>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="./../../public/imgs/nav-img/nav-3.png">
                                        </div>
                                        <div class="pro-name">小米cc9</div>
                                        <div class="pro-price">2999</div>
                                    </a>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="./../../public/imgs/nav-img/nav-4.png">
                                        </div>
                                        <div class="pro-name">小米cc9</div>
                                        <div class="pro-price">2999</div>
                                    </a>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="./../../public/imgs/nav-img/nav-5.png">
                                        </div>
                                        <div class="pro-name">小米cc9</div>
                                        <div class="pro-price">2999</div>
                                    </a>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="./../../public/imgs/nav-img/nav-6.png">
                                        </div>
                                        <div class="pro-name">小米cc9</div>
                                        <div class="pro-price">2999</div>
                                    </a>
